...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_ID= "COLUMN_IDE";
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableStatment = "CREATE TABLE "+ STUDENT_TABLE + " (" + COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + COLUMN_STUDENT_NAME + " TEXT, " + COLUMN_STUDENT_AGE + " INT )";
